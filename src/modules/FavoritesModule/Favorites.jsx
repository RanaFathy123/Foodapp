...
try {
  ...
  toast.success('Reciepe Deleted From Your Favorite')
  getFavoritesList()
} catch (error) {
  console.log(error);
}
      ...
      <div className="d-flex flex-wrap justify-content-center gap-3 align-items-center mt-5 ">
        {favoritesList.map((favorite) => (
          ...
          >
            ...
            <span className="position-absolute top-0 end-0 mt-2 me-2 border border-2 px-2 rounded" onClick={()=>deleteFavorite(favorite)}>
